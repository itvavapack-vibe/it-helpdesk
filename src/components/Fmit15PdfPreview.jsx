...
const Fmit15PdfPreview = ({ isOpen, onClose, formData }) => {
    ...
    const CheckBox = ({ checked, label }) => (
        <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
            ...
            {label && <span style={{ fontSize: '14px', fontWeight: 'bold' }}>{label}</span>}
        </div>
    );
                    ...
                    >
                        ...
                        <div style={{ border: '2px solid #1e3a8a', display: 'flex', marginBottom: '15px' }}>
                            ...
                            <div style={{ width: '75%', padding: '10px 15px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Doc. Type</div>
                                <div style={{ display: 'flex', alignItems: 'flex-end', marginTop: '2px' }}>
                                    <div style={{ fontSize: '15px', fontWeight: 'bold' }}>Change Request Form (FMIT 15)</div>
                                    <div style={{ fontSize: '12px', fontWeight: 'bold', marginLeft: '10px', paddingBottom: '2px', flex: 1, whiteSpace: 'nowrap', textAlign: 'right' }}>
                                        ITC No. 
                                        <span style={{ display: 'inline-block', minWidth: '80px', borderBottom: '1px dotted #000', textAlign: 'center', color: '#1e3a8a', margin: '0 5px' }}>
                                            {formData.ticketNumber ? formData.ticketNumber.split('/')[0] : ''}
                                        </span>
                                        /
                                        <span style={{ display: 'inline-block', minWidth: '80px', borderBottom: '1px dotted #000', textAlign: 'center', color: '#1e3a8a', marginLeft: '5px' }}>
                        ...
                        {/* Request Type */}
                        <div style={{ display: 'flex', gap: '20px', alignItems: 'center', marginBottom: '10px', paddingLeft: '10px' }}>
                            <span style={{ fontSize: '14px', fontWeight: 'bold' }}>ความต้องการ</span>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <span style={{ borderBottom: '1px dotted #000', width: '250px', display: 'inline-block', marginLeft: '5px' }}>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #000', marginBottom: '15px' }}>
                            <tbody>
                                <tr>
                                    <td colSpan="3" style={{ backgroundColor: '#e5e7eb', border: '1px solid #000', padding: '5px 10px', fontSize: '14px', fontWeight: 'bold' }}>
                                        ส่วนที่ 1 : ผู้ร้องขอเปลี่ยนแปลงระบบ
                                    </td>
                                </tr>
                                <tr>
                                    <td style={{ width: '20%', border: '1px solid #000', padding: '5px 10px', fontSize: '14px', fontWeight: 'bold' }}>
                                        แผนก/ฝ่าย ผู้ร้องขอ
                                    </td>
                                ...
                                <tr>
                                    <td colSpan="3" style={{ border: '1px solid #000', padding: '5px 10px', height: '100px', verticalAlign: 'top', position: 'relative' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold', marginBottom: '5px' }}>Details of the Proposed Changes: (รายละเอียด)</div>
                                        <div style={{ fontSize: '14px', whiteSpace: 'pre-wrap' }}>{formData.requestDetails}</div>

                                        {/* Background lines for aesthetics like the template */}
                                ...
                                <tr>
                                    <td colSpan="3" style={{ border: '1px solid #000', padding: '5px 10px', height: '80px', verticalAlign: 'top', position: 'relative' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold', marginBottom: '5px' }}>Reason for changes: (เหตุผลการเปลี่ยนแปลง)</div>
                                        <div style={{ fontSize: '14px', whiteSpace: 'pre-wrap' }}>{formData.reason}</div>
                                ...
                                <tr style={{ height: '50px' }}>
                                    <td style={{ border: '1px solid #000', padding: '5px', width: '33.33%', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Requested by : (ชื่อผู้ร้องขอ)</div>
                                    ...
                                    <td style={{ border: '1px solid #000', padding: '5px', width: '33.33%', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Position (ตำแหน่ง) :</div>
                                        <div style={{ height: '30px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', fontSize: '14px' }}>
                                            {formData.requesterPosition}
                                        </div>
                                    </td>
                                    <td style={{ border: '1px solid #000', padding: '5px', width: '33.33%', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Date (วันที่) :</div>
                                        <div style={{ height: '30px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', fontSize: '14px' }}>
                                            ......./......./.......
                                        </div>
                                    </td>
                                ...
                                <tr style={{ height: '50px' }}>
                                    <td style={{ border: '1px solid #000', padding: '5px', width: '33.33%', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Approve by : (ชื่อผู้อนุมัติ)</div>
                                        <div style={{ height: '30px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                                    ...
                                    <td style={{ border: '1px solid #000', padding: '5px', width: '33.33%', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Date (วันที่) :</div>
                                        <div style={{ height: '30px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', fontSize: '14px' }}>
                                            {formData.managerDate ? new Date(formData.managerDate).toLocaleDateString('th-TH') : '......./......./.......'}
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #000', marginBottom: '15px' }}>
                            <tbody>
                                ...
                                <tr>
                                    <td style={{ width: '33.33%', border: '1px solid #000', padding: '5px 10px', fontSize: '14px', fontWeight: 'bold' }}>
                                        วันที่รับคำร้องขอ : {formData.itReceivedDate}
                                    </td>
                                    <td colSpan="2" style={{ border: '1px solid #000', padding: '5px 10px', fontSize: '14px', fontWeight: 'bold' }}>
                                        วันที่ดำเนินการ : {formData.itOperationDate}
                                    </td>
                                </tr>
                                <tr>
                                    <td colSpan="3" style={{ backgroundColor: '#f3f4f6', border: '1px solid #000', padding: '5px 10px', fontSize: '14px', fontWeight: 'bold' }}>
                                        วันที่นัดหมายแล้วเสร็จ : {formData.itTargetDate}
                                    </td>
                                </tr>
                                <tr>
                                    <td colSpan="3" style={{ border: '1px solid #000', padding: '10px', height: '60px', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '14px', fontWeight: 'bold', marginBottom: '10px' }}>ผลการพิจารณาการขอเปลี่ยนแปลงระบบ:</div>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', minWidth: '300px' }}>
                                                ...
                                                <span style={{ borderBottom: '1px dotted #000', flex: 1, display: 'inline-block', marginLeft: '5px' }}>
                                ...
                                <tr style={{ height: '50px' }}>
                                    ...
                                    <td style={{ border: '1px solid #000', padding: '5px', width: '33.33%', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Date (วันที่) :</div>
                                        <div style={{ height: '30px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', fontSize: '14px' }}>
                                            {formData.itManagerDate ? new Date(formData.itManagerDate).toLocaleDateString('th-TH') : '......./......./.......'}
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colSpan="3" style={{ border: '1px solid #000', padding: '5px 10px', height: '80px', verticalAlign: 'top', position: 'relative' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold', marginBottom: '5px' }}>Solution (วิธีแก้ไข):</div>
                                        <div style={{ fontSize: '14px', whiteSpace: 'pre-wrap' }}>{formData.itSolution}</div>
                                ...
                                <tr style={{ height: '50px' }}>
                                    <td style={{ border: '1px solid #000', padding: '5px', width: '33.33%', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Operated by : (ชื่อผู้ดำเนินการ)</div>
                                        <div style={{ height: '30px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                                    ...
                                    <td style={{ border: '1px solid #000', padding: '5px', width: '33.33%', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Date (วันที่) :</div>
                                        <div style={{ height: '30px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', fontSize: '14px' }}>
                                            {formData.itOperationDate ? new Date(formData.itOperationDate).toLocaleDateString('th-TH') : '......./......./.......'}
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #000', marginBottom: '15px' }}>
                            <tbody>
                                ...
                                <tr style={{ height: '50px' }}>
                                    <td style={{ border: '1px solid #000', padding: '5px', width: '33.33%', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Receive Project (ลงชื่อผู้รับงานรับทราบ)</div>
                                        <div style={{ height: '30px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                                    ...
                                    <td style={{ border: '1px solid #000', padding: '5px', width: '33.33%', verticalAlign: 'top' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 'bold' }}>Date (วันที่) :</div>
                                        <div style={{ height: '30px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', fontSize: '14px' }}>
                                            {formData.userAcceptDate ? new Date(formData.userAcceptDate).toLocaleDateString('th-TH') : '......./......./.......'}
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        {/* Footer */}
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', fontWeight: 'bold', marginTop: 'auto', borderTop: '2px solid #1e3a8a', paddingTop: '5px' }}>
